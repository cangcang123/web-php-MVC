                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <?php foreach ($data["showmain1"] as $value) { ?>
                            <div class="col-md-4">
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget widget-slider">
                            ...
                            <div class="sidebar-slider normal-slider">
                                <?php foreach ($data["showmain2"] as $value) { ?> 
                                <div class="product-item">
                                    <div class="product-title">
                                        <a href="./product/ShowProduct/<?php echo $value["id"]?>"><?php echo $value["name"] ?></a>
                                        <div class="ratting">
                                    ...
                                    <div class="./product/ShowProduct/<?php echo $value["id"]?>">
                                        <a href="./product/ShowProduct/<?php echo $value["id"]?>">
                                            <img src="./public/image/<?php echo $value["image"]?>" alt="Product Image">
                                        </a>
                                        <div class="product-action">
                        ...
                        <div class="sidebar-widget brands"> Views
                            ...
                            <ul>
                                ...
                                <li><a class="nav-link dropdown-toggle"   href="./homeC/showname1F/<?php echo $value["idnamepro"]?>/<?php echo $value["idlist"]?>"><?php echo $value["name"]?> </a><span>(45)</span>
                                </li>
