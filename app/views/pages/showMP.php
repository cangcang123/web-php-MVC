                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget brands"> Views
                            ...
                            <?php foreach ($data["listshow"] as $value) { ?>
                            <ul>
                                <li><a class="nav-link dropdown-toggle"  href="./homeMP/shownamelist/<?php echo $value["idlist"]?>"><?php echo $value["name"]?> </a><span>(45)</span>
