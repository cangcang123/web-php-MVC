                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    <?php for($t=1; $t<=$data["sotrang"]; $t++){  ?>
                                    <li class="page-item active"><a class="page-link" href="./homeM/showclotheM/<?php echo"pages=".$t?>"><?php echo $t ?></a></li>
                                <?php }?>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="col-lg-4 sidebar">
                        ...
                        <div class="sidebar-widget brands"> Views
                            ...
                            <?php foreach ($data["namepro"] as $value) { ?>
                            <ul>
                                <li><a class="nav-link dropdown-toggle"  href="./homeM/shownameM/<?php echo $value["idname"]?>"><?php echo $value["name"]?> </a><span>(45)</span>
