                  ...
                  <div class="card card-default" data-scroll-height:max>
                    <div class="card-header justify-content-between mb-4">
                      ...
                      <tr>
                        ...
                        <td><a href="./Listproduct/DeleteProduct/<?php echo $value["id"]?>">xóa</a>&emsp; &emsp;<a href="./Listproduct/UpdateProduct/<?php echo $value["id"]?>">sửa</a>&emsp; &emsp;<a href="./ListImage/ShowImage/<?php echo $value["id"]?>">Xem</a></td>
